 ...
 */
class MediaAccountTimelineEvent extends Event
{
    /**
    ...
    /**
     * MediaAccount entity for the mediaAccount the timeline is being generated for.
     *
     * @var MediaAccount
     */
    ...
    /**
     * MediaAccountTimelineEvent constructor.
     *
    ...
    {
        return [
            'mediaAccountId' => ($this->mediaAccount instanceof MediaAccount) ? $this->mediaAccount->getId() : null,
            'limit'          => $this->limit,
    ...
    /**
     * Fetches the mediaAccount being acted on.
     *
     * @return MediaAccount
     */
    ...
    /**
     * Returns the mediaAccount ID if any.
     *
     * @return int|null
     */
    public function getMediaAccountId()
    {
        return ($this->mediaAccount instanceof MediaAccount) ? $this->mediaAccount->getId() : null;
    }
